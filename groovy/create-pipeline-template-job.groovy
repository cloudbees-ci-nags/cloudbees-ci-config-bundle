...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/cloudbees-ci-nags/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>cloudbees-ci-nags</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>cloudbees-ci-nags</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/cloudbees-ci-nags/pipeline-template-catalog.git</repositoryUrl>
              <traits>
